---
name: quality-report
description: QA report template — structured test results, coverage metrics, failed test analysis, build status, and recommendations. Save to .agents/reports/.
---
...
- **Performance**: LCP Xs, CLS X, INP Xms
...
- Include ALL failed tests with error messages — do not summarize away details
...
- Keep report under 200 lines; split into sections if scope is larger
- Save using naming pattern from `## Naming` section injected by hooks
