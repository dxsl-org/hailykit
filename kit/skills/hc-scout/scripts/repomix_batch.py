...
class EnvLoader:
    ...
    def load_env_files() -> Dict[str, str]:
        ...
        search_paths = [
            ...
            script_dir.parent / ".env",                 # skill/.env (scout/.env)
        ]
...
def main():
    ...
    parser.add_argument("--style", choices=["xml", "markdown", "json", "plain"], default="xml")
    parser.add_argument("-o", "--output-dir", default="repomix-output")
