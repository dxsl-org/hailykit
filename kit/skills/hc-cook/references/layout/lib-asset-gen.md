...
# Fast iteration (exploring concepts) — MiniMax cheaper
python scripts/minimax_cli.py \
  --task generate \
  --model image-01 \
  --prompt "[your design-driven prompt]" \
  --output docs/assets/concept.png
```
...
Read `docs/assets/hero-image.png` directly to evaluate the generated asset:
