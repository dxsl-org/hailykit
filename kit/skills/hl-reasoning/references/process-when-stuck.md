...
|------------------|-----------------|----------|
| **Complexity spiraling** | Same thing 5+ ways, growing special cases, excessive if/else | process-simplification.md |
| **Need innovation** | Conventional inadequate, can't find fitting approach, need breakthrough | process-collision-zone.md |
| **Recurring patterns** | Same issue different places, reinventing wheels, déjà vu feeling | process-meta-patterns.md |
| **Forced by assumptions** | "Must be done this way", can't question premise, forced solution | process-inversion.md |
| **Scale uncertainty** | Production unclear, edge cases unknown, unsure of limits | process-scale.md |
