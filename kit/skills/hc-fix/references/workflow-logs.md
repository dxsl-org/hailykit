...
Use `hc:scout` agent or parallel `Explore` subagents to find issue locations.
...
Use `haily-tester` agent. If issues remain → keep T5 `in_progress`, loop back to Step 2.
