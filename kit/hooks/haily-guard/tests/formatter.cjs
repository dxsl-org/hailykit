#!/usr/bin/env node
/**
 * formatter.cjs - Unit tests for error module
 */
...
console.log('Testing error module...\n');

// formatConfigPath tests
console.log('--- formatConfigPath Tests ---');
test('formatConfigPath with claudeDir', formatConfigPath('/home/user/.claude').includes('haily.json'));
test('formatConfigPath prefers explicit configPath', formatConfigPath('/home/user/.claude', '/tmp/project/haily.json') === '/tmp/project/haily.json');
test('formatConfigPath without claudeDir', formatConfigPath(null) === '.claude/haily.json');
test('formatConfigPath empty string', formatConfigPath('') === '.claude/haily.json');
...
const blockError = formatBlockedError({
  ...
  configPath: '/home/user/project/haily.json'
});
...
test('formatBlockedError prefers explicit config path', blockError.includes('/home/user/project/haily.json'));
...
const machineError = formatMachineError({
  ...
  tool: 'Read',
  claudeDir: '.claude',
  configPath: '/tmp/project/haily.json'
});
...
test('formatMachineError has config field', parsed.config === '/tmp/project/haily.json');
test('formatMachineError has fix field', parsed.fix.includes('"dist"') && parsed.fix.includes('guard.allow'));
