#!/usr/bin/env node
/**
 * pattern.cjs - Unit tests for pattern module
 */

const path = require('path');
const { loadPatterns, createMatcher, matchPath, DEFAULT_PATTERNS } = require('../pattern.cjs');
...
console.log('Testing pattern module...\n');
